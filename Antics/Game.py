			...
			if self.state.phase != MENU_PHASE:
				#init game stuffs
					#build a list of things to place
						...
						thingsToPlace = []
						thingsToPlace += [Building(None, Contruction.ANTHILL, i, 3) for i in xrange(0,2)]
						thingsToPlace += [Construction(None, Construction.GRASS) for i in xrange(0,18)]
						thingsToPlace += [Construction(None, Constriction.FOOD) for i in xrange(0,4)]
